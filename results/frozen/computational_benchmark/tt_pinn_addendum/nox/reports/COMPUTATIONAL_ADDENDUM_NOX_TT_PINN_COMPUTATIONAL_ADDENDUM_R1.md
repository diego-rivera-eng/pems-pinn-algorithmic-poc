# Addendum computacional post hoc — NOX — R1
...
| --- | --- | --- | --- | --- | --- | --- |
| DENSE_PINN | 69187 | 0.286885 | 0.2024 | 0.2516 | 2.05159e+07 | 68544 |
| TT_PINN | 13891 | 0.074829 | 1.23945 | 2.53176 | 3.18681e+06 | 51456 |

La TT-PINN reduce parámetros en
`79.92%`, el checkpoint en
`73.92%` y los MAC lineales
del forward en `24.93%`.
En esta GPU, su razón de latencia TT/denso fue
`6.12x` y su razón de throughput
TT/denso fue `0.155x`.
...
| --- | --- | --- | --- | --- |
| NOX | DENSE_PINN | 68544 | 137088 | linear_forward_only_excludes_bias_activation_loss_backward |
| NOX | TT_PINN | 51456 | 102912 | linear_forward_only_excludes_bias_activation_loss_backward |
...
| Paper PDE residual plus IC/BC/collocation objective reproduced | NOT_REPRODUCED | NOX uses a monotonic first-derivative regularizer, not a PDE residual with initial/boundary conditions |
